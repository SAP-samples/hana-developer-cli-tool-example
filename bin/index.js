...
const commandFiles = [
    ...
    './dataDiff.js', './dataProfile.js', './dataTypes.js', './dataTypesUI.js', './dataVolumes.js', './disks.js', './dropGroup.js',
    './dropContainer.js', './export.js', './expensiveStatements.js', './features.js', './featuresUI.js', './featureUsage.js', './featureUsageUI.js',
    ...
    './massConvert.js', './massConvertUI.js', './massRename.js', './massUsers.js', './memoryAnalysis.js',
    './objects.js', './openBAS.js', './openDBExplorer.js', './ports.js', './privilegeError.js',
    './procedures.js', './queryPlan.js', './querySimple.js', './querySimpleUI.js', './readMe.js', './readMeUI.js',
