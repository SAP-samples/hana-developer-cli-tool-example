...
}, false)).wrap(160).example('hana-cli hcStart --name myInstance', baseLite.bundle.getText('hcStartExample')).wrap(160).epilog(buildDocEpilogue('hanaCloudStart', 'hana-cloud', ['hanaCloudStop', 'hanaCloudInstances']))
