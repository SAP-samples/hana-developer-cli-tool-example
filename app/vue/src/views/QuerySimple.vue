...
import QueryTabBar from '../components/QueryTabBar.vue'
...
const PlanTree = defineAsyncComponent(() => import('../components/PlanTree.vue'))
const ResultDiffView = defineAsyncComponent(() => import('../components/ResultDiffView.vue'))
