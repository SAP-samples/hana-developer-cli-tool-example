...
For Linux and macOS users, this repository includes a convenient installation script `scripts/install-btp.sh` that automates the installation of the BTP CLI.
