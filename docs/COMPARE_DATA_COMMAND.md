# Compare Data Command Documentation

## Overview

The `compareData` command allows you to compare data between two tables or schemas to identify differences. This is useful for data validation, reconciliation, and identifying changes between systems.
