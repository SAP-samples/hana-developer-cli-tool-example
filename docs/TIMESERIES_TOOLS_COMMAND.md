# Time-Series Tools Command Documentation

## Overview

The `timeSeriesTools` command provides specialized tools for analyzing, aggregating, and forecasting time-series data in SAP HANA. It enables advanced temporal data analysis including anomaly detection and pattern discovery in time-stamped data.
