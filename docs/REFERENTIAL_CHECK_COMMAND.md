# Referential Check Command

## Overview

The `referentialCheck` command verifies referential integrity and validates foreign key constraints in HANA tables. It identifies orphaned records and constraint violations that could indicate data quality issues.
...
hana-cli refcheck --table ORDERS --schema SALES
```
